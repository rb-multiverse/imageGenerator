...
const ImageGenerationForm = () => {
  ...
  return (<div className="imageGen">
    <div>
        <h1 className="font-extrabold text-[#222328] text-[32px]">Prompt Your <span>Creativity!</span></h1>
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Write your prompt and let your creativity run wild!</p>
      </div>
